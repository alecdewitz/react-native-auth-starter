...
function Albums() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', paddingBottom: 20 }}>
      {albums.map((album) => (
        <TouchableOpacity key={album.name} style={{ flexDirection: 'row', marginTop: 10 }}>
            ...
            <View>
              ...
              <View style={styles.interactButtonsView}>
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ ...styles.interactButtonText, color: '#4b7bec' }}>Message</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={{ paddingHorizontal: 25, marginTop: 10 }}>
                <Text style={{ fontSize: 16 }}>
                  {'Followed by '}
                  <Text style={{}}>john_doe </Text>
                  {'and '}
                  <Text style={{}}>19 others</Text>
                </Text>
              </View>
            </View>
            {/* Profile Content */}
